...
output = tf.nn.softmax(tf.matmul(hidden, W_output)+b_output) # softmax 改为 sigmoid函数(1-dim)
...
optimizer = tf.train.GradientDescentOptimizer(0.01) #事实证明GradientDescent算法很垃圾 用Adam
